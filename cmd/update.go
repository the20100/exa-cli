...
// update self-updates the exa binary by cloning the latest source from GitHub,
...
const repoURL = "https://github.com/the20100/exa-cli"

func newUpdateCmd() *cobra.Command {
	return &cobra.Command{
		Use:   "update",
		Short: "Update exa to the latest version from GitHub",
...
func runUpdate(cmd *cobra.Command, args []string) error {
	...
	tmpDir, err := os.MkdirTemp("", "exa-update-*")
	if err != nil {
	...
	newBin := filepath.Join(tmpDir, "exa-cli")
